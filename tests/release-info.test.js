...
test('release notes are read from the changelog', () => {
  assert.equal(normalizeTag('refs/tags/v0.16.0'), '0.16.0');
  assert.match(releaseNotes(process.cwd(), 'v0.16.0'), /Downloads/);
});
