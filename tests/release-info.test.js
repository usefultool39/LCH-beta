...
test('release notes are read from the changelog', () => {
  assert.equal(normalizeTag('refs/tags/v0.18.0'), '0.18.0');
  assert.match(releaseNotes(process.cwd(), 'v0.18.0'), /Downloads/);
});