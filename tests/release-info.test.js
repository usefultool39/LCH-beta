...
test('release notes are read from the changelog', () => {
  assert.equal(normalizeTag('refs/tags/v0.4.1'), '0.4.1');
  assert.match(releaseNotes(process.cwd(), 'v0.4.1'), /Downloads/);
});
